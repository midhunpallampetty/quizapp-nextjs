...
import defaultQuestions from "@/data/QuestionList";
    ...
    <div className="text-white mt-14 ml-14">
      {!submitted ? (
        <div>
          ...
          <div className="mb-6">
            ...
            {questions[currentQuestion].options.map((option: string) => (
              <label
                key={option}
                className="block mb-2 font-mono font-extrabold text-3xl bg-transparent border-2 mt-4 p-4"
              >
                <input
                  type="radio"
          ...
          {currentQuestion < questions.length - 1 ? (
            <button
              ...
              className="bg-blue-500 w-[250px] ml-[600px] h-[50px] text-3xl pb-4 text-white px-4 py-2 rounded-lg font-bold mr-4"
            >
              Next
            </button>
          ) : (
            <button
              ...
              className="bg-green-500 border-none w-[250px] h-[50px] ml-[550px] text-white px-4 py-2 rounded-lg font-bold mr-4"
            >
              Submit
            </button>
          )}
        ...
        <div>
          ...
          <div className="ml-[250px] text-5xl font-serif text-green-500 font-extrabold">
            Your score: {score} / {questions.length}
          </div>
          <button
            onClick={resetQuiz}
            className="bg-blue-500 w-[150px] h-[50px] font-bold ml-[250px] text-white px-4 py-2 rounded-lg font-bold mt-4"
          >
            Retake Quiz
          </button>
        </div>
