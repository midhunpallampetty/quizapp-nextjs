    ...
    <>
      ...
      <div className='text-white font-extrabold flex flex-col '>
        <div className='ml-[240px] rounded-xl mt-20 '>
          ...
          <input placeholder=' Enter New Question' onChange={(e) => addNewQuestion(e.target.value)} type='text' className='border-slate-700-800 border-2 justify-center w-[600px] h-[40px] text-black' />
        </div>
